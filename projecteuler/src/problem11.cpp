 ...
 *
 * In the 20 x 20 grid below, four numbers along a diagonal line have been quoted.
 *
...
static const std::vector<std::vector<std::uint8_t>> inputGrid =
{
...
int main()
{
    ...
    {
        for (std::uint8_t j = 0; j < inputGrid[i].size(); ++j)
        {
            // Up and down are the same (vertically)
            ...
            // Left and right are the same (horizontally)
            ...
            // Handle diagonals left to right
            if ((i < maxVerticalIndex) && (j < maxHorizontalIndex))
            {
                ...
                {
                    maxProduct = leftRightDiagProduct;
                }
            }

            // Handle diagonals right to left
            if ((i >= numberToMul) && (j < maxHorizontalIndex))
            {
                ...
                {
                    maxProduct = rightLeftDiagProduct;
                }
            }
        }
    }
